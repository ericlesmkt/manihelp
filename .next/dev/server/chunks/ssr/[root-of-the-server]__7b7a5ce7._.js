...
function NewAppointmentModal({ isOpen, onClose, manicureId, onAppointmentCreated }) {
    ...
    const [clientMode, setClientMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('existing'); // NOVO ESTADO
    ...
    const createNewClient = async (name, phone)=>{
        // Cria um ID único para o cliente não-logado
        const tempId = crypto.randomUUID();
        const { data, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert({
            id: tempId,
            name: name,
            phone_number: phone,
            role: 'client'
...
// --- Componente: NotificationBell (Requerido pelo Header) ---
// Colocando aqui para garantir que o Header funcione
function NotificationBell({ manicureId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetchNotifications();
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].channel(`manicure_notifications_${manicureId}`).on('postgres_changes', {
            event: 'INSERT',
            schema: 'public',
            table: 'notifications',
...
// --- Componente: Header (Com Links e Bell Ativo) ---
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            manicureId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(NotificationBell, {
...
function UpcomingAppointments({ appointments, isLoading, error }) {
    ...
    const getClientName = (appt)=>appt.client_id && appt.client_id[0] ? appt.client_id[0].name : 'Cliente Desconhecido';
...
function DashboardPage() {
    ...
    const fetchAppointments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        `).eq('manicure_id', manicureId).gte('start_time', yesterday.toISOString()) // Traz a partir de ontem
            .order('start_time', {
                ascending: true
            });
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b7a5ce7._.js.map