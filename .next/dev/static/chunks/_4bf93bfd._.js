...
// CORREÇÃO: Adicionado todos os ícones necessários para o Header e a página
...
function ServicesPage() {
    ...
    const fetchServices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ServicesPage.useCallback[fetchServices]": async (id)=>{
            setError(null);
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('services').select('*').eq('manicure_id', id).order('name', {
                    ascending: true
                });
    ...
    // 1. CARREGAMENTO E AUTORIZAÇÃO (Função aninhada para resolver o escopo)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        router,
        fetchServices
    ]); // Dependência de fetchServices
    // Adicionar Novo Serviço
    const handleAddService = async (e)=>{
        e.preventDefault();
        setIsSaving(true);
        setError(null);
        if (!manicureProfile || !newService.name || newService.price <= 0 || newService.duration <= 0) {
            setError('Preencha nome, preço e duração válidos.');
            setIsSaving(false);
            return;
        }
        const newEntry = {
        ...
        try {
            ...
            fetchServices(manicureProfile.id); // Atualiza a lista
        } catch (e) {
            setError(e.message);
        } finally{
            setIsSaving(false);
    ...
    const handleDeleteService = async (id)=>{
        ...
        if (!manicureProfile || !confirm('Tem certeza que deseja excluir este serviço?')) return;
        setIsSaving(true);
        setError(null);
        try {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Seu catálogo de serviços, preços e duração para agendamento."
                            }, void 0, false, {
                                fileName: "[project]/app/services/page.tsx",
                                lineNumber: 187,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            services.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: "Nenhum serviço cadastrado. Comece adicionando um!"
                            }, void 0, false, {
                                fileName: "[project]/app/services/page.tsx",
                                lineNumber: 268,
                                columnNumber: 25
...
_s(ServicesPage, "RIXf4fsVIBwmtR94/pGeuenjlEU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = ServicesPage;
// Reutiliza o componente Header (com imports corrigidos)
...
//# sourceMappingURL=_4bf93bfd._.js.map