...
function UpcomingAppointments({ appointments, isLoading, error }) {
...
function PendingAppointmentsCard({ appointments, onConfirm, isConfirming }) {
...
function DashboardPage() {
    ...
    const fetchAppointments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchAppointments]": async ()=>{
            // Não seta isLoading(true) aqui para evitar o "piscar"
            // setIsLoading(true); 
            setError(null);
            if (!manicureId) return;
            try {
        ...
        `).eq('manicure_id', manicureId).gte('start_time', yesterday.toISOString()).order('start_time', {
                ...
                setIsLoading(false); // Seta como falso apenas no final da primeira carga
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            async function checkAuthAndRole() {
                setIsLoading(true); // Garante que o loading apareça na entrada
    ...
    // 2. CORREÇÃO: REALTIME EM VEZ DE POLLING
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            if (manicureId) {
                // 1. Busca inicial
                ...
                const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`dashboard_appointments_${manicureId}`).on('postgres_changes', {
                    ...
                    schema: 'public',
                    table: 'appointments',
                    filter: `manicure_id=eq.${manicureId}` // Apenas da manicure logada
                }, {
    ...
    const handleAppointmentCreated = ()=>{
        ...
        // O Realtime (useEffect 2) cuidará da atualização, 
        // mas chamamos o fetchAppointments para garantir a atualização IMEDIATA.
        fetchAppointments();
    };
...
_s1(DashboardPage, "1XOU4Z0jhkL4QFACBRcRhom+b6g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_25c2690b._.js.map