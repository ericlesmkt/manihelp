...
"[project]/components/EditServiceModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditServiceModal({ isOpen, onClose, service, onSave }) {
    ...
    const handleSave = async (e)=>{
        ...
        setError(null);
        try {
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('services').update({
                name: formData.name,
                price: priceValue,
...
_s(EditServiceModal, "gVsAPSqJcprN1/53jgR3cULZMfo=");
_c = EditServiceModal;
var _c;
__turbopack_context__.k.register(_c, "EditServiceModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabaseClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$EditServiceModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/EditServiceModal.tsx [app-client] (ecmascript)");
...
function ServicesPage() {
    ...
    const fetchServices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ServicesPage.useCallback[fetchServices]": async (id)=>{
            setError(null);
            try {
                // Renomeia 'duration_minutes' para 'duration' no retorno do select para bater com o tipo ServiceItem
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('services').select('id, name, price, duration_minutes, description').eq('manicure_id', id).order('name', {
                    ascending: true
                });
                if (error) throw new Error(error.message);
                // Mapeia os dados para o tipo ServiceItem, renomeando duration_minutes para duration
                const safeData = (data || []).map({
                    "ServicesPage.useCallback[fetchServices].safeData": (service)=>({
                            id: service.id,
                            name: service.name,
                            price: service.price,
                ...
                }["ServicesPage.useCallback[fetchServices].safeData"]);
    ...
    }["ServicesPage.useCallback[fetchServices]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServicesPage.useEffect": ()=>{
            async function checkAuthAndLoadProfile() {
                ...
                const { data: profile, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, name, role').eq('id', user.id).single();
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "ServicesPage.useEffect": (event)=>{
                    if (event === 'SIGNED_OUT') router.replace('/');
                }
            }["ServicesPage.useEffect"]);
            return ({
                "ServicesPage.useEffect": ()=>subscription.unsubscribe()
            })["ServicesPage.useEffect"];
        }
    }["ServicesPage.useEffect"], [
        router,
    ...
    const handleAddService = async (e)=>{
        ...
        try {
            const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('services').insert([
                newEntry
            ]);
            if (insertError) {
    ...
    const handleDeleteService = async (id)=>{
        ...
        setError(null);
        try {
            const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('services').delete().eq('id', id);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$EditServiceModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                isOpen: isModalOpen,
...
_s1(ServicesPage, "fy+nEAWX2cFJunK2RfaTtm6tOO8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_4f959184._.js.map